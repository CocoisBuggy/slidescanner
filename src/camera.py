...
class CameraManager:
    ...
    def set_state_event_handler(self):
        ...
        if err == EDS_ERR_OK:
            print("State event handler registered successfully")
        else:
            print(f"Failed to register state event handler: {err}")
